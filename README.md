...
Desenvolvedor de software com foco em backend, automação e projetos de IA. Buscando oportunidades em desenvolvimento de software e dados/IA.

**Stack:** Python, JavaScript/TypeScript, Java, C/C++, Node.js, React, PostgreSQL, Docker

**Projetos em destaque**

**NewNimbus** — SaaS de automação de ofertas via WhatsApp (Node.js, React, Postgres, Redis, Stripe, ~286 testes)

**TCC2** — Trabalho de conclusão de curso sobre orquestração de múltiplas ferramentas e LLMs
